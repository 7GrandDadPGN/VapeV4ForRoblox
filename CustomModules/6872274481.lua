		...
		Function = function(callback) 
			...
			if viewmodel then
				if callback then
					...
					bedwars.ViewmodelController:setHeldItem(lplr.Character:FindFirstChild("HandInvItem") and lplr.Character.HandInvItem.Value and lplr.Character.HandInvItem.Value:Clone())
