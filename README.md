...
```luau
loadstring(game:HttpGet("https://raw.githubusercontent.com/codingfirewastaken/CojingaVape/main/NewMainScript.lua", true))()
```
...
2. Making sure you have connection to [the main loadstring.](https://raw.githubusercontent.com/codingfirewastaken/CojingaVape/refs/heads/main/NewMainScript.lua)
